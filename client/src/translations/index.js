...
const translateTimeAllPlural = ({ translations, values }) =>
...
const spanish = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  const timeLeft = translateCommonWithPlural({
    translations: {
      months: 'meses',
      days: 'dias',
...
const portuguese = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  const timeLeft = translateCommonWithPlural({
    translations: {
      months: 'meses',
      days: 'dias',
...
const turkish = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
...
const danish = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  const timeLeft = translateCommonWithPlural({
    translations: {
      months: 'måneder',
      month: 'måned',
...
const russian = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  let timeLeft = '';
...
const french = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  const timeLeft = translateCommonWithPlural({
    translations: {
      months: 'mois',
      days: 'jours',
...
const slovak = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  let timeLeft = '';
...
const czech = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  let timeLeft = '';
...
const german = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
  const timeLeft = translateCommonWithPlural({
    translations: {
      months: 'Monate',
      days: 'Tage',
...
Object.keys(allTranslations).forEach((language) => {
  if (!translations[language]) {
    translations[language] = ({ isNewYearsDay, months, days, hours, minutes, seconds }) => {
      const timeLeft = translateCommonWithPlural({
